...
$o_config->control_structure_id2 = 29;
...
$q = "update alumno_has_ciclo_has_pago set alumno_id = 831, descripcion = 'CANCELADO', monto = 0 where id = $folio";
$o_database->query_assign($q);

$q = "delete from recibo_has_pago where ahc_has_pago_id = $folio";;
$o_database->query_assign($q);
