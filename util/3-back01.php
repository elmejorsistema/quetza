...
switch($semestre)
  ...
  case 4:
    ...
    // Estos son los talleres para primer año
      if(($materia_id > 95 and $materia_id < 106) or $materia_id == 114 or ($materia_id >=  120 and $materia_id <= 121) or ($materia_id >=  124 and $materia_id <= 133) or ($materia_id >=  172 and $materia_id <= 177))
      {
...
echo"<tr><td id=\"tdenvia2\" class=\"titulo-alumno\" colspan=\"9\"><button id=\"benvia2\" type=\"submit\" onFocus=\"\" onBlur=\"\" class=\"alumno-salvado\" formaction=\"util/6.php\" formmethod=\"POST\">Datos Guardados</button>";
