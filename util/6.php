...
// Esto es para que solamente calcule el promedio de las tres parciales sin examen final
//$q= "
//update alumno_has_evaluacion set calif_5 = round((if(calif_1 >= 0, calif_1, 0) + if(calif_2 >= 0, calif_2, 0) + if(calif_3 >= 0, calif_3, 0)) / 3,1)
//where ciclo_has_materia_id = $chm_id";
